                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('account-register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required disabled autocomplete="email">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">Select Your POD</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="optionsRadios" disabled=""><span class="circle"></span><span class="check"></span>
                                        Microsoft Azure
                                    </label>
                                </div>
                                <div class="radio">
